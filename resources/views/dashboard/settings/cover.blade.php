    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="animated fadeIn">
                ...
                direction: rtl;">
                                <form action="{{ route('dashboard.setting.change_cover') }}" method="POST"
                                    ...
                                    <div class="row" style="padding: 5px 25px">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <img src="{{ asset('home/images/bg/bg1.jpg') }}?v={{ setting('cover_time') }}"
                                                style=" margin-top: 10px; max-width: 250px; margin-bottom: 35px"
                                                alt="">
                                        </div>
                                        {{-- <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="who_video" class="form-control" >{{ setting('who_video') }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="text" name="cta_title" value="{{ setting('cta_title') }}"
                                                        class="form-control col-md-4" placeholder="title">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" name="cta_text" value="{{ setting('cta_text') }}"
                                                        class="form-control col-md-4" placeholder="text">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="text" name="cta_name" value="{{ setting('cta_name') }}"
                                                        class="form-control col-md-4" placeholder="button name">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" name="cta" value="{{ setting('cta') }}"
                                                        class="form-control col-md-4" placeholder="url">
                                                </div>
                                            </div>
                                        </div>
