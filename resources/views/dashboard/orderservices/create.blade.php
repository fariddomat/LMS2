...
<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('dashboard.orderservices.index') }}">orderservices</a></li>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> إضافة خدمة
            </div>
            <div class="card-block ">
                <form action="{{ route('dashboard.orderservices.store' ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
