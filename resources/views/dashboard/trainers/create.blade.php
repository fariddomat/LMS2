    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> إضافة مدرب
            </div>
            <div class="card-block ">
                <form action="{{ route('dashboard.trainers.store' ) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="first_name" id="spec" value="{{ old('first_name') }}"
                            aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="name">الاسم الاخير</label>
                        <input type="text" class="form-control" name="last_name" id="spec" value="{{ old('last_name') }}"
                            aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="name">التوصيف</label>
                        <input type="text" class="form-control" name="title" id="spec" value="{{ old('title') }}"
                            aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="mobile" id="twitter" value="{{ old('mobile') }}"
                            aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group ">
                        <label for="name">البريد الالكتروني</label>
                        <input type="email" class="form-control" name="email" id="twitter" value="{{ old('email') }}"
                    ...
                    <div class="form-group mb-3">
                        <img src="" style="width: 300px;" class="img-thumbnail image-preview"
                            alt="">
                    </div>
                    <div class="form-group">
