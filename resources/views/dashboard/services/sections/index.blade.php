...
@section('content')
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.services.index') }}">service</a>
            </li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <a href="{{ route('dashboard.sections.create', $service->id) }}" class="btn btn-primary">إضافة</a>
                            @if (count($sections) > 0)
                                        ...
                                        @forelse ($sections as $section)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        action="{{ route('dashboard.sections.destroy', $section) }}"
