...
@section('content')
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.sections.index', $service->id) }}">sections</a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form action="{{ route('dashboard.sections.store', $service->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if ($errors->any())
