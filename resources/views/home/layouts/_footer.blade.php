             ...
             <div class="row">
                 ...
                 <div class="col-md-6 col-lg-6 col-xl-4">
                     <div class="widget widget_nav_menu">
                         <h4 class="widget-title widget-title-line-bottom line-bottom-theme-colored1">وسائل الدفع
                             المتاحة</h4>
                         <ul>
                             <li>
                                 <img src="{{ asset('paymentslogo/pngwing.com.png') }}" style="max-width: 140px"
                                     alt="">
                             </li>
                             {{-- <li>
                         ...
                         <div class="opening-hours border-dark">
                             <ul>
                                 ...
                                 @foreach ($courses_count as $course)
                                     <li><a href="{{ route('courses.show', $course->title) }}">{{ $course->title }}</a>
                                     </li>
                                 @endforeach
                             </ul>
                         </div>
                         <ul class="styled-icons icon-dark icon-sm icon-circled mt-30">
                             <li><a class="social-link" data-tm-bg-color="#A8CDD1"
                                     href="{{ setting('site_email') }}"><i class="fa fa-envelope"></i></a></li>
                             <li><a class="social-link" data-tm-bg-color="#A8CDD1"
                                     href="{{ setting('instagram2_link') }}"><i class="fab fa-instagram"></i></a></li>
                             <li><a class="social-link" data-tm-bg-color="#A8CDD1"
                                     href="{{ setting('twitter_link') }}"><i class="fab fa-twitter"></i></a></li>
                             <li><a class="social-link" data-tm-bg-color="#A8CDD1"
                                     href="{{ setting('whatsapp_link') }}"><i class="fab fa-whatsapp"></i></a></li>
